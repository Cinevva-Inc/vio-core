//@ts-ignore
import { Body, Shape, Vec3, World, Box, Sphere, Plane, ConvexPolyhedron, Trimesh, Heightfield, Material } from 'cannon';
import { BoxGeometry, CylinderGeometry, Mesh, MeshBasicMaterial, PlaneGeometry, SphereGeometry, Vector3 } from 'three';
import { Face3, Geometry } from './DeprecatedGeometry';
